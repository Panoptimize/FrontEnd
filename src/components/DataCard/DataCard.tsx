...
const DataCard: React.FC<IDataCard> = ({
  ...
  return (
    <div className="flex flex-auto h-24 px-2 pt-3 pb-2 bg-white border border-gray-200 rounded-3xl shadow flex-col justify-center items-start">
